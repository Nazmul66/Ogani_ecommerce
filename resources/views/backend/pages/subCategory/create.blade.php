...
@section('page-titles')
    <title>Create SubCategory | Admin Dashboard </title>
@endsection
                  ...
                  <div class="card-body">
                    <form method="POST" action="{{ route('subCategory.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="subCat_name" type="text" name="subCat_name" class="form-control" required autocomplete="off" placeholder="Write the SubCategory name">
                        </div>
