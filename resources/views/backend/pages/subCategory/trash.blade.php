...
@section('page-titles')
    <title>Manage Trash SubCategory | Admin Dashboard </title>
@endsection
            ...
            <div class="page-header">
                <nav aria-label="breadcrumb" style="background: #FFF">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Trash SubCategory</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ( $sub_categories as $key=>$sub_cat )
                                    <tr>
                                        ...
                                        <ul class="action_list">
                                            <li style="background: #157347;">
                                                <a href="{{ route('subCategory.edit', $sub_cat->id) }}">
                                                    <i class="far fa-edit"></i>
                                                </a> 
                                            </li>
                                            <li style="background: #BB2D3B;">
                                                <span data-toggle="modal" data-target="#subCategoryTrash{{ $sub_cat->id }}">
                                    ...
                                    <!-- Modal start -->
                                    <div class="modal fade" id="subCategoryTrash{{ $sub_cat->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Do you want to delete this data Permanent!</h5>
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <a href="{{ route('subCategory.trash-destroy', $sub_cat->id) }}" class="btn btn-primary">Confirm</a>
                                                </div>
