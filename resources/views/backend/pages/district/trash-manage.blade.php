...
@section('page-titles')
    <title>Manage Trash District | Admin Dashboard </title>
@endsection
            ...
            <div class="page-header">
                <nav aria-label="breadcrumb" style="background: #FFF">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Trash District</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center card-header ">
                    <h5 class="mb-0">Manage Trash District</h5>
                  ...
                  <div class="card-body">
                    ...
                    @if ( $districts->count() == 0 )
                        <div class="alert alert-danger" role="alert">
                           Oops! there is no trash districts data here.
                        </div>
                    @else
                        <table class="table">
                            <thead>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <a href="{{ route('district.trash-destroy', $district->id) }}" class="btn btn-primary">Confirm</a>
                                                </div>
