...
@section('page-titles')
    <title>Manage Trash Warehouse | Admin Dashboard </title>
@endsection
            ...
            <div class="page-header">
                <nav aria-label="breadcrumb" style="background: #FFF">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Trash Warehouse</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center card-header">
                    <h5 class="mb-0">Manage Trash Warehouse</h5>
                    <a href="{{ route('warehouse.manage') }}">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                <a href="{{ route('warehouse.trash-destroy', $warehouse->id) }}" class="btn btn-primary">Confirm</a>
                                            </div>
