...
@section('page-titles')
    <title>Manage ChildCategory | Admin Dashboard </title>
@endsection
            ...
            <div class="page-header">
                <nav aria-label="breadcrumb" style="background: #FFF">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage childCategory</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center card-header ">
                    <h5 class="mb-0">Manage ChildCategories</h5>
                    <a href="{{ route('childCategory.trash-manage') }}">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <a href="{{ route('childCategory.destroy', $child_cat->id) }}" class="btn btn-primary">Confirm</a>
                                                    </div>
