...
@section('page-titles')
    <title>Manage Brand | Admin Dashboard </title>
@endsection
                            ...
                            <tbody>
                                @foreach ( $brands as $key=>$brand )
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('backend/uploads/brand/' . $brand->brand_logo ) }}" alt="">
                                        </td>
                                        <td>
                                            @if ( $brand->status == 1 )
                                        ...
                                        <td>
                                            <ul class="action_list">
                                                ...
                                                <li style="background: #BB2D3B;">
                                                    <span data-toggle="modal" data-target="#brand{{ $brand->id }}"><i class="fas fa-trash"></i></span> 
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <a href="{{ route('brand.destroy', $brand->id) }}" class="btn btn-primary">Confirm</a>
                                                </div>
