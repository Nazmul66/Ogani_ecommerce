...
@section('page-titles')
    <title>Manage Division | Admin Dashboard </title>
@endsection
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="d-flex justify-content-between align-items-center card-header ">
                    <h5 class="mb-0">Manage Divisions</h5>
                    <a href="{{ route('division.trash-manage') }}">
                  ...
                  <div class="card-body">
                    ...
                    @if ( $divisions->count() == 0 )
                        <div class="alert alert-danger" role="alert">
                           Oops! there is no divisions data here.
                        </div>
                    @else
                        <table class="table">
                            <thead>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-center">
                                                    ...
                                                    <a href="{{ route('division.destroy', $division->id) }}" class="btn btn-primary">Confirm</a>
                                                </div>
