                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product__details__text">
                            ...
                            <div style="color: #6f6f6f">Product Views: {{ $products->product_view }} <i class="fa fa-eye" aria-hidden="true"></i></div>
                                ...
                                <div class="product__details__price">Price: {{ $setting->currency }}{{ $products->price }}/-
                                </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="{{ route('campaign.product.details', $related_prdt->slug) }}">{{ $related_prdt->product_name }}</a></h6>
                                    <h5></h5>
                                </div>
                            </div>
                        </div>
